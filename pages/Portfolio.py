...
##    linkedin_link = f'<a href = "{info.my_github_url}"><img src = "{info.github_image_url}" alt = "Github" width = "65" height = "65"></a>'
...
# education
def eduction_section(education_data, course_data):
    st.header("Education")
...
eduction_section(info.education_data, info.course_data)
